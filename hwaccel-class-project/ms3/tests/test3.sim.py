# TEST 3: Performance test for the hardware accelerated systems with the larger
# accelerator memory when multiplying larger matrices than supported with the
...
for lat in [10000000000, 1000000000, 1000000, 1000]:
  ...
  hwaccel = HWAccelSim(lat, 128, 6 * 128 * 128)
  hwaccel.name = 'accel'
  hwaccel.sync = True
